...
namespace sisorg_automation_exam_MP.Tools.ChromeDriverDownload
{
    public class DriverDownload
    {
        ...
        public string DownloadDriverAndGetFolderPath()
        {
            ...
            var pathfolderFull = Path.Combine(InitialPath, chromeVersion, "chromedriver-win32");
            ...
            if (!File.Exists(pathFile))
            {
                ...
                DownloadDriver(pathfolderDownload, chromeFullVersion);
            }
        ...
        private void DownloadDriver(string pathfolderToDownload, string productFullVersion)
        {
            HttpContent httpContentZip = new DriverDownloadLastStableVersion().GetHttpContentZip();
